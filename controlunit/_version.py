...
the browser, one switch per curve in its own chart's legend, a Vacuum and a
Plasma preset over those switches, a Monitor mode that gives the charts the
whole window and keeps the rails in edge drawers, and two pills

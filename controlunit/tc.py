...
def meter(meter, mv):
    ...
    if meter == "u1272a" or meter == "u1271a":
        ...
        raise ValueError(
            "Invalid meter type for the --meter option. Use the --help option for more information."
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs=1,
        type=str,
        choices=["u1271a", "u1272a", "187", "189", "83v", "87v"],
    )
    ...
    for v in args.values:
        ...
        try:
            if args.meter and args.meter[0] and re.match(r"^mv2", args.mode[0]):
                ...
                print(
                    "{0:.1f} (uncertainty: {1:.1f} to {2:.1f})".format(
                        mid, lower, upper
                    )
                )
